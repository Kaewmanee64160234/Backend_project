...
@Module({
  imports: [
    ...
    // }),
    // TypeOrmModule.forRoot({
    //   type: 'sqlite', // specifying the database type as SQLite
    //   database: './database.sqlite', // path to your database file
    //   entities: [
    //     Customer,
    //     Product,
    //     Catagory,
    ...
    //     Report,
    //   ],
    //   synchronize: true, // synchronize the database schema based on your entities
    // }),
    // TypeOrmModule.forRoot({
    //   type: 'mysql',
